...
EXPECTED_UPSTREAM_PLUGINS = {
    ...
    "J-Quants/jquants-cli": {"fundamental-tools"},
    "FinanceData/OpenDartReader": {"fundamental-tools"},
    "NanookAI/twse-api": {"fundamental-tools"},
    "dgunning/edgartools": {"fundamental-tools"},
    "akfamily/akshare": {"fundamental-tools"},
